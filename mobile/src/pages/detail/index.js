...
export default function Detail(){
  ...
  const mensagem = `Olá, ${incident.name}. 
    Estou entrando em contato pois gostaria de ajudar 
    no caso "${incident.description}" com o valor de ${
  ...
  function sendMail(){
    Linking.openURL(`mailto:${incident.email}?subject=Herói do caso ${incident.title}&body=${mensagem}`);
  }
